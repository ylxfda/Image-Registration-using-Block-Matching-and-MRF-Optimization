...
int main( int argc, char * argv[] )
{
  if( argc < 2 )
    ...
    std::cerr << " itkitkBlockMatchingImageFilterTest fixedImg movingImg warpedFix warpedMov fld2fix fld2mov gridSize numLevel factor sampRate blurFactor thread" << std::endl;
    return EXIT_FAILURE;
    }
